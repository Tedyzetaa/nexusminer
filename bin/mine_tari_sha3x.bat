...
set "POOL=de-eu.luckypool.io:6118"
...
:W10
"%MyVariable%"  --algo SHA3X --pool !POOL! --user !WALLET!  --watchdog exit !EXTRAPARAMETERS!
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
"%MyVariable%"  --algo SHA3X --pool !POOL! --user !WALLET! --watchdog exit !EXTRAPARAMETERS! --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
